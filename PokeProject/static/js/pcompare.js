...
function addB(){
    ...
    var amount = document.getElementsByClassName('label-info');

    if (amount.length < 14) {
        elem.innerHTML += '<span class="label label-info">' + pokeName + '<a name="' + pokeName + '" class="remove" onclick="remove(this)"> <span class="glyphicon glyphicon-remove-circle" style="color: white"></span></a></span> ';
    }
}
